...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary text-sm font-medium leading-5 text-on-surface focus:outline-none focus:border-primary transition duration-150 ease-in-out'
