...
<template>
    ...
    <DashboardLayout activeTab="catalog">
        ...
        <!-- Catalog Link Card -->
        <div class="bg-surface-container-low border border-primary/30 rounded-xl p-5 mb-6">
        ...
        <Link
            :href="catalogUrl"
            target="_blank"
            class="w-full inline-flex items-center justify-center gap-2 bg-primary text-on-primary py-3 px-5 rounded-xl font-bold text-sm hover:brightness-110 active:scale-[0.98] transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/30"
        >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
