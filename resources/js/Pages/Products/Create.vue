        ...
        <div class="max-w-2xl">
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div v-if="form.recentlySuccessful" class="bg-primary/10 border border-primary rounded-lg p-4 text-center" role="status">
                    <p class="text-primary font-bold">Produk berhasil ditambahkan!</p>
                </div>

                <button
                    type="submit"
                    :disabled="form.processing"
                    class="w-full h-12 bg-primary text-on-primary rounded-lg font-bold uppercase tracking-wider hover:brightness-110 active:scale-[0.98] transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/30 disabled:opacity-50 disabled:grayscale"
                >
