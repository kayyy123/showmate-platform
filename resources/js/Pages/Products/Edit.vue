        ...
        <main class="pt-20 pb-24 px-5 max-w-[420px] mx-auto">
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="flex items-center gap-3">
                    <label class="text-sm font-medium text-on-surface" for="is_active">
                        Status Produk
                    </label>
                    <button
                        id="is_active"
                ...
                <div class="flex gap-3">
                    <Link
                        ...
                        class="flex-1 h-12 border border-outline text-on-surface rounded-lg font-bold uppercase tracking-wider flex items-center justify-center hover:bg-surface-container transition-colors"
                    >
                        Batal
                    </Link>
                    <button
