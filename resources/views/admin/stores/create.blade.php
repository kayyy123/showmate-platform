        ...
        <form action="{{ route('admin.stores.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="whatsapp" class="form-custom @error('whatsapp') is-invalid @enderror" value="{{ old('whatsapp') }}" placeholder="62812xxxxxx">
                    @error('whatsapp') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-custom-label">Instagram</label>
                    <input type="text" name="instagram" class="form-custom @error('instagram') is-invalid @enderror" value="{{ old('instagram') }}">
                    @error('instagram') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-custom-label">TikTok</label>
                    <input type="text" name="tiktok" class="form-custom @error('tiktok') is-invalid @enderror" value="{{ old('tiktok') }}">
                    @error('tiktok') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-custom-label">Shopee</label>
                    <input type="text" name="shopee" class="form-custom @error('shopee') is-invalid @enderror" value="{{ old('shopee') }}">
                    @error('shopee') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-custom-label">Tokopedia</label>
                    <input type="text" name="tokopedia" class="form-custom @error('tokopedia') is-invalid @enderror" value="{{ old('tokopedia') }}">
